...
local Window = Rayfield:CreateWindow({
   ...
   KeySettings = {
      ...
      FileName = "TestingKey", -- It is recommended to use something unique as other scripts using Rayfield may overwrite your key file
      SaveKey = false, -- The user's key will be saved, but if you change the key, they will be unable to use your script
      GrabKeyFromSite = true, -- If this is true, set Key below to the RAW site you would like Rayfield to get the key from
      Key = {"https://pastebin.com/raw/Xr2VnFty"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
   }
})
...
if os.date("%m %d") == "04 01" then
	if math.random(1, 4) == 1 then
		createPopup("AMONG US JUMPSCARE AMONG US DIES TOMORROW!!\n\nidk april fools")
	end
	Title.Text = string.gsub(Title.Text, "Infinite Yield FE", "fortnite hack")
end
